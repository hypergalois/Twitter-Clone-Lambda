function setProfileDataEdit() {
  ...
  //   // Edit profile
  //   document.getElementById('edit_profile_follow_button').innerHTML = 'Edit profile'
  //   document.getElementById('edit_profile_follow_button').setAttribute('onclick', 'document.location.replace("editprofile.html")')
  // } else {
  //   // Follow
